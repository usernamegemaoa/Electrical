 ...
 * File:   spi-AD7147.c
 * Author: Intern-Carl
 * C code file with functions to initialize the AD7147 for SPI
 * This is a warmup 
 * Created on December 28, 2016, 4:08 PM
 */
#include <xc.h>
#include "AD7147-Registers.h"
#include "spi-AD7147.h"
#include "spi.h"
...
{   
	...
	read_AD7147(STAGE_LOW_LIMIT_INT, 3, AD7147Registers, STAGE_LOW_LIMIT_INT); //Registers 0x08 & 0x09 & 0x0A
